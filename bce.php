...
<nav class="navbar navbar-expand-lg navbar-light bg-dark">
    ...
    <div class="header">
    <h1 style="display:flex;align-items:center;margin:30px 0;justify-content:space-between">Students of B.C.E <a href='section.php' style="margin-left:10px;" class="btn btn-success">Back</a></h1>
    <form action="table.php" method="POST" style="display:flex; margin-bottom:20px">
